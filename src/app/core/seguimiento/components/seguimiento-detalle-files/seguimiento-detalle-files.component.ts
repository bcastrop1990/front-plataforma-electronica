...
@Component({
  selector: 'app-seguimiento-detalle-files',
  templateUrl: './seguimiento-detalle-files.component.html',
  styleUrls: ['./seguimiento-detalle-files.component.scss']
})
export class SeguimientoDetalleFilesComponent implements OnInit {
  ...
  constructor(public dialog: MatDialogRef<SeguimientoDetalleFilesComponent>,
