...
export class SeguimientoService {
  ...
  getDocumentosRespuesta(nroSolicitud: string) {
    return this.http.get<DocumentosRespuestaOut>(
      `${this.url}/solicitudes/firma/${nroSolicitud}`
    );
  }

  setSharedData(data: Fechas): void {
    this.sharedData = data;
  }

  getSharedData(): Fechas {
